...
const LoginForm = () => {
  ...
  return (
    <form
      ...
      onSubmit={handleSubmit((data) => SignIn(data.password, data.email))}>
      ...
      <p className="flex justify-center w-full">{errors.root?.message}</p>
      <FormInput
        label="Email"
      ...
      <div className="flex justify-between items-center mb-8 w-full">
        <label
          ...
          className="flex select-none items-center gap-2 text-darkGray2 text-sm tracking-veryTight hover:animate-bounce transition-all"
          htmlFor="RememberMe">
          <input
            ref={checkBoxRef}
