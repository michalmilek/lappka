...
const Volunteering = () => {
  return (
    <div className="min-w-[272px] min-h-[360px] bg-white flex flex-col rounded-lg shadow-md gap-7">
      ...
      <div className="flex flex-col px-6 items-start justify-center w-full">
        ...
        <div className="flex justify-start w-full items-center gap-3 px-4 pb-3 border-b-2 ">
