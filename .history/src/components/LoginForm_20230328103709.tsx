  ...
  return (
    <form
      ...
      <div className="flex justify-between items-center mb-8 w-full">
        <label
          onClick={() => console.log(checkBoxRef.current)}
          className="flex items-center gap-2 text-darkGray2 text-sm tracking-veryTight hover:animate-bounce transition-all"
          htmlFor="RememberMe">
          <input
            ref={checkBoxRef}
