...
const Card = () => {
  return (
    <div className="bg-white flex min-w-[272px] min-h-[82px] items-start pl-5 py-4">
      <AnimalsCardIcon className="p-2 flex gap-5 justify-center items-center h-10 w-10 rounded-full bg-bgGreen" />
      <div>
