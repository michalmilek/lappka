...
const Sidebar = () => {
  return (
    <div className="px-3 py-5 min-h-screen flex flex-col min-w-[250px]">
      <div className="flex flex-col items-start justify-start gap-11">
        ...
        <ul className="flex flex-col items-start justify-center gap-1 w-full">
          ...
          <li className="listLink relative">
            ...
            <span className="absolute right-0 bg-orange flex justify-center items-center top-[50%] translate-y-[-50%]">
              56
            </span>
          </li>
          <li className="listLink">
