...
const Sidebar = () => {
  ...
  return (
    <div className="px-3 py-5 pb-10 min-h-screen flex flex-col min-w-[200px] justify-between">
      ...
      <div className="flex flex-col gap-4">
        ...
        <ul className={`${isOpen ? "flex flex-col" : "none"}`}>
          <li className="listLink">test</li>
          <li className="listLink">test</li>
          <li className="listLink">test</li>
          <li className="listLink">test</li>
          <li className="listLink">test</li>
