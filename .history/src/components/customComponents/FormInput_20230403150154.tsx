  ...
  return (
    <div className="flex flex-col gap-1 items-start justify-center mb-4 w-full">
      ...
      <input
        {...rest}
        ref={ref}
        className="w-full transition-all border !ring-0 focus:border-lightGray1 focus:ring-0 !outline-none focus:outline-none border-lightGray1 rounded-md py-2 px-3 placeholder:text-midGray4 tracking-veryTight text-sm"
      />
